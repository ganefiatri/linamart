    ...
    <div class="main-container container">
        ...
        <div class="row">
            <div class="col-12">
                ...
                @endphp
                @if ($unread > 0)
                <form action="{{ route('driver.notification.markasread') }}" method="POST" class="mb-3" id="mark-read-form">
                    @csrf
                    @method('PATCH')
                ...
                <div class="list-group list-group-flush bg-none rounded-0 mb-3">
                    ...
                    <a href="{{ route('driver.notification.show', $item->id) }}" class="list-group-item">
                        <div class="row">
