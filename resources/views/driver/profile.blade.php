    ...
    <div class="main-container container">
        ...
        <div class="row  mb-4">
            <div class="col-auto">
                <figure class="avatar avatar-100 rounded mx-auto">
                    {{ $driver->getImage(100, 100, ['class' => 'img-fluid'], true) }}
                </figure>
            </div>
            <div class="col align-self-center">
                <h5 class="">{{ $driver->name }}</h5>
                <p class="text-opac">{{ $driver->address }}</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-light shadow-sm mb-4">
                    <div class="card-body">
                        <form method="POST" action="{{ route('driver.updateprofile') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row mt-3">
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="form-group form-floating  mb-3">
                                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" 
                                            value="{{ $driver->name }}" placeholder="Name" id="names">
                                        @error('name')
                                ...
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="form-group form-floating  mb-3">
                                        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" 
                                            value="{{ $driver->email }}" placeholder="Email" id="email">
                                ...
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="form-group form-floating  mb-3">
                                        <input type="test" name="phone" class="form-control @error('phone') is-invalid @enderror" 
                                            value="{{ $driver->phone }}" placeholder="Phone" id="phone">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-light shadow-sm mb-4">
                    <div class="card-body">
                        <form method="POST" action="{{ route('driver.password') }}">
                            @csrf
                            <div class="row h-100">
                                <div class="col-12 col-md-6 col-lg-4">
