                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                <a href="{{ route('admin.product-categories.create') }}" class="btn btn-outline-secondary">
                                ...
                                <table class="table mb-2 table-striped">
                                    ...
                                    @foreach ($items as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.product-categories.show', $item->id) }}" class="view">
                                                    {{ $item->title }}
                                                </a>
                                            </td>
                                            <td>{{ $item->slug }}</td>
                                            <td class="text-center">
                                                <ul class="list-unstyled list-inline">
                                                    <li class="list-inline-item">
                                                        <a href="{{ route('admin.product-categories.edit', $item->id) }}" title="edit">
                                                            <i class="bi bi-pencil-square size-22"></i>
                                                        </a>
                                                    </li>
                                                    <li class="list-inline-item">
                                                        <form action="{{ route('admin.product-categories.destroy',$item->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
