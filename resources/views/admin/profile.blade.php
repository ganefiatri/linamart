    ...
    <header class="container-fluid header">
        <div class="row h-100">
            <div class="col-auto align-self-center">
                <a href="{{ route($admin->role .'.home') }}" class="btn btn-link back-btn text-color-theme">
            ...
            <div class="col-auto align-self-center">
                <a href="{{ route($admin->role .'.home') }}" class="link text-color-theme">
        ...
        <div class="row  mb-4">
            <div class="col-auto">
                <figure class="avatar avatar-100 rounded mx-auto">
                    {{ $admin->getImage(100, 100, ['class' => 'img-fluid'], true) }}
                </figure>
            </div>
