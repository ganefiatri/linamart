        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="row mb-2">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                <a href="{{ route('super.shippings.create') }}" class="btn btn-outline-secondary">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <form action="{{ route('super.shippings.index') }}" class="d-flex align-items-center add-contact__form my-sm-0 my-2">
                                ...
                                <table class="table mb-2 table-striped">
                                    ...
                                    @foreach ($items as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('super.shippings.show', $item->id) }}" class="view">
                                                    {{ $item->title }}
                                                </a>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <ul class="list-unstyled list-inline">
                                                    <li class="list-inline-item">
                                                        <a href="{{ route('super.shippings.edit', $item->id) }}" title="edit">
                                                            <i class="bi bi-pencil-square size-22"></i>
                                                        </a>
                                                    </li>
                                                    <li class="list-inline-item">
                                                        <form action="{{ route('super.shippings.destroy',$item->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
