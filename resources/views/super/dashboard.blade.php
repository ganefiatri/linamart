            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="row">
                    <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                        <a href="{{ route('super.products.index') }}" title="Lihat daftar produk">
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                        <a href="{{ route('super.shops.index') }}" title="Lihat daftar toko">
                        <div class="card shadow-sm product mb-4">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-auto">
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                        <a href="{{ route('super.members.index') }}" title="Lihat daftar member">
                        <div class="card shadow-sm product mb-4">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-auto">
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                        <a href="{{ route('super.drivers.index') }}" title="Lihat daftar driver">
                        <div class="card shadow-sm product mb-4">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-auto">
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                        <a href="{{ route('super.notification') }}" title="Lihat pemberitahuan">
                        <div class="card shadow-sm product mb-4">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-auto">
