                ...
                <div class="row mb-2">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                <a href="{{ route('super.product-categories.index') }}" class="btn btn-outline-success">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <form action="{{ route('super.products.index') }}" class="d-flex align-items-center add-contact__form my-sm-0 my-2">
                                ...
                                <table class="table mb-2 table-striped">
                                    ...
                                    @foreach ($items as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('super.shops.show', $item->shop_id) }}" class="view">
                                                    {{ !empty($item->shop) ? $item->shop->name : '-' }}
                                                </a>
                                            </td>
                                            <td>
                                                <a href="{{ route('super.products.show', $item->id) }}" class="view">
                                                    {{ $item->title }}
                                                </a>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <ul class="list-unstyled list-inline">
                                                    <li class="list-inline-item">
                                                        <a href="{{ route('super.products.edit', $item->id) }}" title="edit">
                                                            <i class="bi bi-pencil-square size-22"></i>
                                                        </a>
                                                    </li>
                                                    <li class="list-inline-item">
                                                        <form action="{{ route('super.products.destroy', $item->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
...
<div class="modal fade" id="shop-modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered">
        <div class="modal-content product border-0 shadow-sm">
            ...
            <form action="{{ route('super.products.create') }}">
...
@section('js')
    ...
    function chooseShop(dt)
    {
        ...
        if (shop_id > 0) {
            window.location.href = "{{ route('super.products.index') }}?shop_id=" + shop_id;
        }
        return false;
    }
    </script>
