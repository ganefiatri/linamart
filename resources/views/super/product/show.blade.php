            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="row mb-2">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <a href="{{ route('super.products.index') }}" class="btn btn-outline-secondary">
                            <i class="bi bi-list-ul"></i> {{ __('List Product') }}
                        </a>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 text-end">
                        <a href="{{ route('super.products.edit', $product->id) }}" class="btn btn-outline-secondary">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tr>
                                    <td>{{ __('Shop Name') }}</td>
                                    <td>
                                        <a href="{{ route('super.shops.show', $product->shop_id) }}" target="_newtab">
                                    ...
                                    <tr>
                                        <td>{{ __('Shop Owner') }}</td>
                                        <td>
                                            <a href="{{ route('super.members.show', $product->shop->member_id) }}" target="_newtab">
