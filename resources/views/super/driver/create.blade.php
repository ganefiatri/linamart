            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="d-flex flex-wrap justify-content-center mb-3">
                    <div class="d-flex align-items-center">
                        <h4 class="mb-2">{{ __('Create Driver') }}</h4>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header color-dark fw-500">{{ __('Add New Driver') }}</div>
                    <div class="card-body p-4">
                        ...
                        @endif
                        <form method="POST" action="{{ route('super.drivers.store') }}" >
                            @method('POST')
                            @csrf
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="email" class="form-control" id="email" placeholder="Masukkan alamat" name="email" value="{{ old('email') }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="form-group col-sm-6">
