        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="row mb-2">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                <a href="{{ route('super.members.create') }}" class="btn btn-outline-secondary">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <form action="{{ route('super.members.index') }}" class="d-flex align-items-center add-contact__form my-sm-0 my-2">
                                ...
                                <table class="table mb-2 table-striped">
                                    ...
                                    @foreach ($items as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('super.members.show', $item->id) }}" class="view">
                                                    {{ $item->name }}
                                                </a>
                                            </td>
                                            <td>{{ $item->email }}</td>
                                            ...
                                            <td class="text-center">
                                                <ul class="list-unstyled list-inline">
                                                    <li class="list-inline-item">
                                                        <a href="{{ route('super.members.edit', $item->id) }}" title="edit">
                                                            <i class="bi bi-pencil-square size-22"></i>
                                                        </a>
                                                    </li>
                                                    <li class="list-inline-item">
                                                        <form action="{{ route('super.members.destroy',$item->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
