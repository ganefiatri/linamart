            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="d-flex flex-wrap justify-content-center mb-3">
                    <div class="d-flex align-items-center">
                        <h4 class="mb-2">{{ __('Admin List') }}</h4>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                <a href="{{ route('super.admins.create') }}" class="btn btn-outline-secondary">
                                    <i class="bi bi-plus-square"></i> {{ __('Add Admin') }}
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <form action="{{ route('super.admins.index') }}" class="d-flex align-items-center add-contact__form my-sm-0 my-2">
                ...
                <!-- endsearch -->
                <div class="card">
                    <div class="card-header color-dark fw-500">{{ __('Admin List') }}</div>
                                ...
                                <table class="table mb-2 table-striped">
                                    ...
                                    @foreach ($items as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('super.admins.show', $item->id) }}" class="view">
                                                    {{ $item->name }}
                                                </a>
                                            </td>
                                            <td>{{ $item->email }}</td>
                                            ...
                                            <td class="text-center">
                                                <ul class="list-unstyled list-inline">
                                                    <li class="list-inline-item">
                                                        <a href="{{ route('super.admins.edit', $item->id) }}" title="edit">
                                                            <i class="bi bi-pencil-square size-22"></i>
                                                        </a>
                                                    </li>
                                                    <li class="list-inline-item">
                                                        <form action="{{ route('super.admins.destroy',$item->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
