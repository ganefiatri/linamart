                        ...
                        <form method="POST" action="{{ route('products.update', $product->id) }}" >
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="text" class="form-control" id="name" placeholder="Masukkan nama produk" name="title" value="{{ $product->title }}" required>
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="slug">Slug :</label>
                                    <input type="text" class="form-control" id="slug" placeholder="Masukkan Slug, ex: the-product-name" name="slug" value="{{ $product->slug }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="form-group col-sm-12">
                                    <label for="content">{{ __('Description') }} :</label>
                                    <textarea class="form-control" id="content" name="description" placeholder="Masukkan deskripsi produk">{{ $product->description }}</textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="form-group col-sm-6">
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="text" class="form-control" id="price" placeholder="Masukkan harga" name="price" value="{{ $product->price }}" required>
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="discount">{{ __('Discount') }} :</label>
                                    <input type="text" class="form-control" id="discount" placeholder="Masukkan diskon" name="discount" value="{{ $product->discount }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="form-group col-sm-6">
                                    <label for="stock">{{ __('Stock') }} :</label>
                                    <input type="text" class="form-control" id="stock" placeholder="Masukkan jumlah stok" name="stock" value="{{ $product->stock }}" required>
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="weight">{{ __('Weight') }} :</label>
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" id="weight" placeholder="Masukkan berat/ukuran produk" name="weight" value="{{ $product->weight }}">
                                        @php
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body p-2">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6 col-md-6 col-sm-6">
                                <form method="POST" action="{{ route('products.image.create', $product->id) }}" enctype="multipart/form-data">
                                    @csrf
