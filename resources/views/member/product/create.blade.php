                        ...
                        <form method="POST" action="{{ route('products.store') }}" >
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="text" class="form-control" id="name" placeholder="Masukkan nama produk" name="title" value="{{ old('title') }}" required>
                                </div>
                                <div class="form-group col-sm-6">
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-sm-12">
                                    ...
                                    <textarea class="form-control" id="content" name="description" placeholder="Masukkan deskripsi">{{ old('description') }}</textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="form-group col-sm-6">
                                    <label for="price">{{ __('Price') }} :</label>
                                    <input type="text" class="form-control" id="price" placeholder="Masukkan harga" name="price" value="{{ old('price') }}" required>
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="discount">{{ __('Discount') }} :</label>
                                    <input type="text" class="form-control" id="discount" placeholder="Masukkan diskon" name="discount" value="{{ old('discount') }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="form-group col-sm-6">
                                    <label for="stock">{{ __('Stock') }} :</label>
                                    <input type="text" class="form-control" id="stock" placeholder="Masukkan stok" name="stock" value="{{ old('stock') }}" required>
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="weight">{{ __('Weight') }} :</label>
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" id="weight" placeholder="Masukkan berat/ukuran produk" name="weight" value="{{ old('weight') }}">
                                        @php
