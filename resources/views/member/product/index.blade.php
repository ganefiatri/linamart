                ...
                <div class="row mb-2">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="row">
                            ...
                            @if (config('global.allow_add_category'))
                            <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                <a href="{{ route('product-categories.index') }}" class="btn btn-outline-success">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <form action="{{ route('products.index') }}" class="d-flex align-items-center add-contact__form my-sm-0 my-2">
                            ...
                            <input class="form-control mr-sm-2 border-0 box-shadow-none" type="search" name="q" placeholder="{{ __('Search by name') }}" 
                                ...
                                <table class="table mb-2 table-striped">
                                    ...
                                    @foreach ($items as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('products.show', $item->id) }}" class="view">
                                                    {{ $item->title }}
                                                </a>
                                            </td>
                                            <td>
