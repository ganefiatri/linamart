...
class MemberController extends Controller
{
    ...
    protected function index(Request $request)
    {
        ...
        return view('super.member.index', compact('items', 'showFooter'));
    }
    ...
    public function create()
    {
        ...
        return view('super.member.create', compact('districts', 'genders', 'statusList'));
    }
    ...
    {
        return view('super.member.show', compact('member'));
    }
    ...
    public function edit(Member $member)
    {
        ...
        return view('super.member.edit', compact('member', 'districts', 'genders', 'statusList'));
    }
