...
class DriverController extends Controller
{
    ...
    protected function index(Request $request)
    {
        ...
        return view('super.driver.index', compact('items', 'showFooter'));
    }
    ...
    public function create()
    {
        ...
        return view('super.driver.create', compact('districts', 'genders', 'statusList'));
    }
    ...
    {
        return view('super.driver.show', compact('driver'));
    }
    ...
    public function edit(Driver $driver)
    {
        ...
        return view('super.driver.edit', compact('driver', 'districts', 'genders', 'statusList'));
    }
    ...
    /**
     * Jump login as driver.
     *
     * @param  \Illuminate\Http\Request  $request
     * @param  \App\Models\Driver  $driver
     * @return \Illuminate\Http\RedirectResponse
     */
    public function loginAs(Request $request, Driver $driver)
    {
        $user = $driver->user;
        if ($user instanceof \App\Models\User) {
            ...
            return redirect(route('driver.dashboard'))->with('message', $message);
        }
