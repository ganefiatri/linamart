...
class ShopController extends Controller
{
    ...
    protected function index(Request $request)
    {
        ...
        return view('super.shop.index', compact('items', 'statusList', 'showFooter'));
    }
    ...
    public function create()
    {
        ...
        return view('super.shop.create', compact('districts', 'statusList', 'members'));
    }
    ...
    public function show(Request $request, Shop $shop)
    {
        ...
        return view('super.shop.show', compact('shop', 'products'));
    }
    ...
    public function edit(Shop $shop)
    {
        ...
        return view('super.shop.edit', compact('shop', 'districts', 'statusList'));
    }
