...
class ProductController extends Controller
{
    ...
    protected function index(Request $request)
    {
        ...
        return view('admin.product.index', compact('items', 'statusList', 'showFooter', 'shops'));
    }
    ...
    public function show(Product $product)
    {
        ...
        return view('admin.product.show', compact('product', 'status_list', 'showFooter'));
    }
    ...
    public function update(Request $request, Product $product)
    {
        ...
        $update_data['priority'] = (isset($update_data['priority'])) ? 2 : 0;
